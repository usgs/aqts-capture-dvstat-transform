...
insert
  into instantaneous_value (
           instantaneous_value_identifier,
...
select ts_description.agency_code ||
           ...
           '-' || ts_description.time_series_unique_id instantaneous_value_identifier,
       ...
       ts_description.parm_cd parameter_code,
